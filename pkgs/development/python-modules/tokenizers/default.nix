...
in rustPlatform.buildRustPackage rec {
  ...
  cargoSha256 = "17mndm78zprmpa7b1f4mh5dk28x8jpcw6dlqag7kbz7i91qv47lq";
  ...
  postUnpack = ''
    ...
    ln -s ${robertaVocab} $sourceRoot/tests/data/roberta-base-vocab.json
    ln -s ${robertaMerges} $sourceRoot/tests/data/roberta-base-merges.txt
    ln -s ${bertVocab} $sourceRoot/tests/data/bert-base-uncased-vocab.txt
    ln -s ${openaiVocab} $sourceRoot/tests/data/openai-gpt-vocab.json
    ln -s ${openaiMerges} $sourceRoot/tests/data/openai-gpt-merges.txt
  '';
